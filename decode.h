...
/* Decode should decompress the file with format ".jay" */
/* It checks for the format in the name */
/* Outputs a file with "fname" - ".jay" */
void decode(dict *d, char *fname, char *op_fname);

/* Decodes the given directory with ".jay" format */
/* It assumes that all encoded files in the directory have ".jay" format */ 
